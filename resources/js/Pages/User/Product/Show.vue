                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li>
                        <div class="flex items-center">
                            <Link :href="route('home')" class="text-sm font-medium text-gray-700 hover:text-indigo-600">Beranda</Link>
                        </div>
                    </li>
                    <li v-if="product.category">
                        <div class="flex items-center">
                            ...
                            <Link :href="route('categories.show', product.category.slug)" class="ml-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ml-2">{{ product.category.name }}</Link>
                        </div>
                    </li>
                        ...
                        <div class="w-full md:w-2/3 lg:w-3/4">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        <!-- Loading spinner -->
                                        <svg v-if="wishlistLoading" class="h-6 w-6 animate-spin text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <div v-if="!page.props.auth?.user" class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded px-2 py-1 whitespace-nowrap opacity-0 pointer-events-none transition-opacity duration-200 hover:opacity-100">
                                        Login diperlukan
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-4 space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <Link v-if="product.category" :href="route('categories.show', product.category.slug)" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ product.category.name }}</Link>
                                    </div>

                                    <div class="flex items-center">
                                        <span class="text-sm text-gray-500 w-20">Supplier</span>
                                        <span v-if="product.supplier" class="text-sm text-yellow-700">{{ product.supplier.name }}</span>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium" :class="product.stock > 0 ? 'text-green-600' : 'text-red-600'">
                                            ...
                                            <span v-if="product.stock > 0" class="text-gray-500">({{ product.stock }} pcs)</span>
                                        </span>
                                    </div>
